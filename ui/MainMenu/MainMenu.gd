...
@onready var _seed_input = $MarginContainer/CenterContainer/VBoxContainer/Seed/Value
@onready var _heirloom = $MarginContainer/CenterContainer/VBoxContainer/Heirloom/Value
